...
export const COMPONENT_PATHS = {
  ...
  SETTINGS_PAGE: 'components/settings/SettingsPage.html',
  CONFIRMATION_MODAL: 'components/common/ConfirmationModal.html',
  TOAST: 'components/common/Toast.html'
};
...
export const COMPONENT_TARGETS = {
  ...
  SETTINGS_PAGE: 'settings-page-component',
